...
export default function KastratIdentity() {
  ...
  const handleContinue = () => {
    ...
    sessionStorage.setItem("kastrat_identity", JSON.stringify(identityData));
    navigate("/kastrat/form");
  };
      ...
      <section className="max-w-2xl mx-auto px-4 md:px-8 py-12">
        ...
        <FadeInUp delay={0.2}>
          <div className="bg-white border border-black/10 rounded-lg shadow-sm p-6 md:p-8 space-y-6 font-agrandir">
            <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-brand-green-start/10 to-brand-green-end/10 rounded-lg border border-brand-green/20">
              <input
                type="checkbox"
                id="anonymous"
                checked={isAnonymous}
              ...
              >
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="border-brand-green/20 focus:border-brand-green"
                  />
                </div>
            ...
            <div className="flex justify-end pt-4">
              <Button
                ...
                className="bg-gradient-to-b from-brand-green-start to-brand-green-end hover:from-brand-blue-start hover:to-brand-blue-end transition-all text-white"
              >
                Lanjutkan ke Form
              </Button>
            </div>
